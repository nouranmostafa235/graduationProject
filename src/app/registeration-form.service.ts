...
export class RegisterationFormService {
  ...
  // firstName: '', Vlidators.required],
  // lastName: '', Vlidators.required],
  ...
  // personalMedicalHistory: ['', Validators.required],
  // personalSurgicalHistory: ['', Validators.required],
  // personalAllergiesHistory: ['', Validators.required],
  ...
  //   password:[''],
  //   maritalStatus:[''],
  //   profile_images:[null,Validators.required],
